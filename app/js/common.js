$(function() {
  ...
  $(document).click(function(event) { 
	...
	$('.login-switch').click(function(e) {
		...
		$('#login-popup .login-form').show();
		$('#login-popup .registration-form').hide();
		$('#login-popup').show();
		$('#login-popup .login-switch').addClass('active');
		$('#login-popup .reg-switch').removeClass('active');
		$('.popup-overlay').show();
	...
	$('.reg-switch').click(function(e) {
		e.preventDefault();

		$('#login-popup .login-form').hide();
		$('#login-popup .registration-form').show();
		$('#login-popup').show();
